...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Soporte360 en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Soporte360 no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Soporte360 a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Soporte360 de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Soporte360 de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Soporte360 use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Soporte360 Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep Soporte360 background service", "Dejar Soporte360 como Servicio en 2do plano"),
        ...
        ("Show Soporte360", "Mostrar Soporte360"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Soporte360 permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Soporte360 permisos de \"Grabar Audio\"."),
        ...
        ("verify_soporte360_password_tip", "Verificar la contraseña de Soporte360"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Soporte360 e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_soporte360_server_pro_to_{}_tip", "¡Por favor, actualiza Soporte360 Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Soporte360 no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Soporte360"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Soporte360 de fondo"),
        ...
        ("About Soporte360", "Acerca de Soporte360"),
        ...
        ("upgrade_remote_soporte360_client_to_{}_tip", "Por favor, actualiza el cliente Soporte360 a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, Soporte360 verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, Rustdesk volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, Soporte360 no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor Soporte360 OSS no incluye esta característica."),
